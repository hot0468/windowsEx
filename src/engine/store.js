...
export const useGame = create((set, get) => ({
  ...
  layOff: (choice) => { rememberEnding('layoff:' + choice); set({ ended: 'layoff:' + choice, ...NO_TOAST, locked: false }) },
  ...
  endGame: (kind) => { rememberEnding(kind); set({ ended: kind, ...NO_TOAST, locked: false }) },
