...
const SRC = { camera, cards, files, map, chat, cmd, doc, exe, folder, globe, hwp, image, mail, mine, notepad, pdf, phone, ppt, settings, shield, trash, trophy, vpn, workchat, xls }
